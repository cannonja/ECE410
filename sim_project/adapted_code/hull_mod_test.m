...
for i = deltas
    Kc = hull_call_mod(S, rf, DTE/360, IV, i);
    Cp = bs_european_call(S, Kc, rf, IV, DTE/360);
    Kp = hull_put_mod(S, rf, DTE/360, IV, -i);
    Pp = bs_european_put(S, Kp, rf, IV, DTE/360);
